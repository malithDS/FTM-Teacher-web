...
$(document).keypress(function(e){ //using keyboard enter key
	...
	/* Send Message	*/	
		...
		if(e.which === 13){ 
				...
				$.ajax({
					type: "POST",
					url: "Lecturer_send_question.php",
					data: {
						msg: $msg,
						id: $id,
					},
...
<table id="chat_room" style="align:center">
	...
	<?php
		$query=mysqli_query($conn,"select nova_class_question_id,nova_sub_class_id,nova_student_id,answer,answer_date,answer_time from `nova_class_question`");
